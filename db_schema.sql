...
-- Passwords: New accounts use bcrypt hashing. Default admin uses plain text
-- for initial setup - the login system handles both formats.
-- ============================================================================
...
-- Default admin account (plain text password for initial setup)
